...
function duaDetail({ navigation }) {
    ...
    return (
        <SafeAreaView style={styles.containerr}>
            ...
            <View style={{ backgroundColor: "#F2F2F2", flex: 1, position: "relative", marginBottom: 40 }}>
                            ...
                            <View style={styles.container}  >
                                <View style={styles.linearGradient}>
                                    ...
                                    <View style={{ with: "100%", flexDirection: "row", justifyContent: "space-between", paddingVertical: 5 }}>
                                        ...
                                        <Text style={{ fontSize: 15, color: "black", fontWeight: 'bold', }}>Ali </Text>
            ...
            <TouchableOpacity activeOpacity={1} style={styles.addNotes} onPress={() => { goToNext() }}>
